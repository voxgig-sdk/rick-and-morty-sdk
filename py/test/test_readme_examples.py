# RickAndMorty SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RickAndMortySDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RickAndMortySDK(...) and RickAndMortySDK.test(...) become
#      RickAndMortySDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "rickandmorty_sdk"
_SDK_CLASS = "RickAndMortySDK"
