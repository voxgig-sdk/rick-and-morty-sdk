...
class RickAndMortyTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RickAndMortyTestRunner.getenv("RICKANDMORTY_TEST_LIVE")
        override = RickAndMortyTestRunner.getenv("RICKANDMORTY_TEST_OVERRIDE")
        ...
        explain = RickAndMortyTestRunner.getenv("RICKANDMORTY_TEST_EXPLAIN")
