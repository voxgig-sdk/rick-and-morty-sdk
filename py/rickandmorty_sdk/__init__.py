...
from rickandmorty_sdk.utility import register

# Load features
from rickandmorty_sdk.feature.base_feature import RickAndMortyBaseFeature
from rickandmorty_sdk.features import _has_feature, _make_feature
...
class RickAndMortySDK:
    ...
    def get_utility(self):
        return RickAndMortyUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("RickAndMortySDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Character(self, data=None) -> "CharacterEntity":
        ...
        from rickandmorty_sdk.entity.character_entity import CharacterEntity
    ...
    def Episode(self, data=None) -> "EpisodeEntity":
        ...
        from rickandmorty_sdk.entity.episode_entity import EpisodeEntity
    ...
    def Location(self, data=None) -> "LocationEntity":
        ...
        from rickandmorty_sdk.entity.location_entity import LocationEntity
        return LocationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RickAndMortySDK":
        if sdkopts is None:
            sdkopts = {}
