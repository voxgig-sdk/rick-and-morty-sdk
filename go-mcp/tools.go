...
func registerTools(server *mcp.Server, client *sdk.RickAndMortySDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "rick-and-morty_list",
		Description: "List records from RickAndMorty. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "rick-and-morty_load",
		Description: "Load a single record from RickAndMorty. " +
...
func runOp(client *sdk.RickAndMortySDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RickAndMortySDK, name string) (sdk.RickAndMortyEntity, error) {
