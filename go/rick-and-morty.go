...
// instead of `sdk.NewRickAndMortySDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *RickAndMortySDK  { return NewRickAndMortySDK(nil) }
func Test() *RickAndMortySDK { return TestSDK(nil, nil) }
