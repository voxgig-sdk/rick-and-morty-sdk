...
The Golang SDK for the RickAndMorty API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/rick-and-morty-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/rick-and-morty-sdk=../path/to/github.com/voxgig-sdk/rick-and-morty-sdk
```
...
```
RICK-AND-MORTY_TEST_LIVE=TRUE
RICK-AND-MORTY_APIKEY=<your-key>
```
...
| `Episode` | `(data map[string]any) RickAndMortyEntity` | Create a Episode entity instance. |
...
```
github.com/voxgig-sdk/rick-and-morty-sdk/
...
The root package (`github.com/voxgig-sdk/rick-and-morty-sdk`) re-exports everything needed
