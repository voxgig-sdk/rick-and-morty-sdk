...
func (sdk *RickAndMortySDK) OptionsMap() map[string]any {
...
func (sdk *RickAndMortySDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RickAndMortySDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RickAndMortySDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RickAndMortySDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RickAndMortySDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RickAndMortySDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RickAndMortySDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RickAndMortySDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RickAndMortySDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RickAndMortySDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *RickAndMortySDK {
	...
	sdk := NewRickAndMortySDK(sdkopts)
	sdk.Mode = "test"
