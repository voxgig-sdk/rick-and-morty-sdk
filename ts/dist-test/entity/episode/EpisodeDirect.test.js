...
(0, node_test_1.describe)('EpisodeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.RickAndMortySDK({
...
function liveScenariosActive() { return false && process.env.RICK_AND_MORTY_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.RickAndMortySDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['RICK_AND_MORTY_TEST_EPISODE_ENTID'];
    ...
    const client = new __1.RickAndMortySDK({
        base: 'http://localhost:8080',
