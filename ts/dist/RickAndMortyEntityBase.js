...
exports.RickAndMortyEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends RickAndMortyEntityBase<Advice>`.
class RickAndMortyEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.RickAndMortyEntityBase = RickAndMortyEntityBase;
//# sourceMappingURL=RickAndMortyEntityBase.js.map