...
func registerSDKWords(r *eng.Registry, client *sdk.RickAndMortySDK) {
...
func runOp(client *sdk.RickAndMortySDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
