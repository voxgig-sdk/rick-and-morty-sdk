module github.com/voxgig-sdk/rick-and-morty-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/rick-and-morty-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/rick-and-morty-sdk/go => ../go
