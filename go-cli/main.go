// Command RickAndMorty-cli is a CLI + REPL for the RickAndMorty SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      RICK_AND_MORTY_APIKEY (api key), RICK_AND_MORTY_BASE (base url override)")
