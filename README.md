...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/rick-and-morty` | `npm install @voxgig-sdk/rick-and-morty` |
| Python | `voxgig-sdk-rick-and-morty` | `pip install voxgig-sdk-rick-and-morty` |
| PHP | `voxgig-sdk/rick-and-morty` | `composer require voxgig-sdk/rick-and-morty` |
| Golang | `github.com/voxgig-sdk/rick-and-morty-sdk/go` | `go get github.com/voxgig-sdk/rick-and-morty-sdk/go` |
| Ruby | `voxgig-sdk-rick-and-morty` | `gem install voxgig-sdk-rick-and-morty` |
| Lua | `voxgig-sdk-rick-and-morty` | `luarocks install voxgig-sdk-rick-and-morty` |
