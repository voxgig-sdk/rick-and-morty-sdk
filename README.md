...
API providing information about characters, locations, and episodes from the Rick and Morty show.

Learn more about Rick and Morty API at [rickandmortyapi.com](https://rickandmortyapi.com).
