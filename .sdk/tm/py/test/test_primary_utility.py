...
from projectname_sdk import RickAndMortySDK
from projectname_sdk.core.spec import RickAndMortySpec
from projectname_sdk.core.result import RickAndMortyResult
from projectname_sdk.core.response import RickAndMortyResponse
from projectname_sdk.core.operation import RickAndMortyOperation
from projectname_sdk.core.error import RickAndMortyError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import RickAndMortyBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return RickAndMortyError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = RickAndMortySDK.test(None, None)
        ...
        class TestInitFeature(RickAndMortyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(RickAndMortyBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = RickAndMortySDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = RickAndMortySpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = RickAndMortySDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = RickAndMortyOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = RickAndMortySDK.test(None, setup_opts)
