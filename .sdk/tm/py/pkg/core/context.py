...
from projectname_sdk.core.control import RickAndMortyControl
...
class RickAndMortyContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, RickAndMortySpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, RickAndMortyResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, RickAndMortyResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RickAndMortyError(code, msg, self)
