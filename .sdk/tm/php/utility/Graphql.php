...
// RickAndMorty SDK utility: graphql
//
...
class RickAndMortyGraphql
{
    ...
    // equivalent.
    public static function body(RickAndMortyContext $ctx): mixed
    {
    ...
    public static function errors(RickAndMortyContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
