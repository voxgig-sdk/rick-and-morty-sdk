...
// RickAndMorty SDK utility: make_options

class RickAndMortyMakeOptions
{
    ...
    public static function call(RickAndMortyContext $ctx): array
    {
        ...
        //
        // `RickAndMortySchema::optspec()` is built from the model:
        ...
        $optspec = RickAndMortySchema::optspec();
