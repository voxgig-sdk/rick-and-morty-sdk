...
// RickAndMorty SDK utility: fetcher
...
class RickAndMortyFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RickAndMortySDK/1.0)';
    ...
    public static function call(RickAndMortyContext $ctx, string $fullurl, array $fetchdef): array
    {
