...
// RickAndMorty SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class RickAndMortyTransformResponse
{
    public static function call(RickAndMortyContext $ctx): mixed
    {
        ...
        $transform = RickAndMortyHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
