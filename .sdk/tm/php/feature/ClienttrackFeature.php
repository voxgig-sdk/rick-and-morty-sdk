...
// RickAndMorty SDK clienttrack feature
...
class RickAndMortyClienttrackFeature extends RickAndMortyBaseFeature
{
    ...
    public function PostConstruct(RickAndMortyContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'RickAndMorty-SDK';
