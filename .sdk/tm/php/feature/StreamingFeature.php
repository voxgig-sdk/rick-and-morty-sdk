...
// RickAndMorty SDK streaming feature
...
class RickAndMortyStreamingFeature extends RickAndMortyBaseFeature
{
    ...
    private function _iterate(RickAndMortyResult $result): \Generator
    {
    ...
    private function _streamable(RickAndMortyContext $ctx): bool
    {
