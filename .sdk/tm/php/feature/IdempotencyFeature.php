...
// RickAndMorty SDK idempotency feature
...
class RickAndMortyIdempotencyFeature extends RickAndMortyBaseFeature
{
    ...
    private function _mutating(RickAndMortyContext $ctx): bool
    {
