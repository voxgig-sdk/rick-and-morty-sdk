...
// RickAndMorty SDK netsim feature
...
class RickAndMortyNetsimFeature extends RickAndMortyBaseFeature
{
    ...
    private function _simulate(RickAndMortyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RickAndMortyContext $ctx, array $applied): void
    {
        $client = $this->client;
