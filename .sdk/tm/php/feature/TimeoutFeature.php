...
// RickAndMorty SDK timeout feature
...
class RickAndMortyTimeoutFeature extends RickAndMortyBaseFeature
{
    ...
    private function _with_timeout(RickAndMortyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RickAndMortyContext $_ctx, float $ms): void
    {
        $client = $this->client;
