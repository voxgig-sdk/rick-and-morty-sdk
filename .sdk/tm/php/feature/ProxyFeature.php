...
// RickAndMorty SDK proxy feature
...
class RickAndMortyProxyFeature extends RickAndMortyBaseFeature
{
    ...
    public function init(RickAndMortyContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RickAndMortyContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
