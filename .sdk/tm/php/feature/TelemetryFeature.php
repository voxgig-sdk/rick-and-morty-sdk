...
// RickAndMorty SDK telemetry feature
...
class RickAndMortyTelemetryFeature extends RickAndMortyBaseFeature
{
    ...
    private function _close(RickAndMortyContext $ctx, bool $ok): void
    {
