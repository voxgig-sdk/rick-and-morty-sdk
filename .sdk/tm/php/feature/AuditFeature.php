...
// RickAndMorty SDK audit feature
...
class RickAndMortyAuditFeature extends RickAndMortyBaseFeature
{
    ...
    private function _emit(RickAndMortyContext $ctx, string $outcome): void
    {
