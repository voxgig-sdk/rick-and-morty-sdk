...
|---|---|---|
| `ts/` | @voxgig-sdk/rick-and-morty-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/rick-and-morty-sdk \
      --repository voxgig-sdk/rick-and-morty-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/rick-and-morty-sdk` shows it, and
`npm trust revoke @voxgig-sdk/rick-and-morty-sdk --id=<id>` removes it.
