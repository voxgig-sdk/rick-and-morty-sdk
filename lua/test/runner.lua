...
function runner.env_override(m)
  local live = runner.getenv("RICKANDMORTY_TEST_LIVE")
  local override = runner.getenv("RICKANDMORTY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RICKANDMORTY_TEST_EXPLAIN")
