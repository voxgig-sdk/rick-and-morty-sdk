...
function runner.env_override(m)
  local live = runner.getenv("RICK_AND_MORTY_TEST_LIVE")
  local override = runner.getenv("RICK_AND_MORTY_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("RICK_AND_MORTY_TEST_EXPLAIN")
