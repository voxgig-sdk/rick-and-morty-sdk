# RickAndMorty Lua SDK



The Lua SDK for the RickAndMorty API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/rick-and-morty-sdk/releases)),
...
| `episode` | `table` | List of episodes in which this character appeared |
...
| `characters` | `table` | List of characters who have been seen in this episode |
...
| `residents` | `table` | List of characters who have been last seen in this location |
...
```
lua/
├── rick-and-morty_sdk.lua    -- Main SDK module
...
The main module (`rick-and-morty_sdk`) exports the SDK constructor
