# RickAndMorty SDK Location entity
...
class LocationEntity
  ...
  # @return [Location, Hash] the loaded Location; raises RickAndMortyError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Location>, Array] the matching Location items; raises RickAndMortyError on failure
