# RickAndMorty SDK Episode entity
...
class EpisodeEntity
  ...
  # @return [Episode, Hash] the loaded Episode; raises RickAndMortyError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Episode>, Array] the matching Episode items; raises RickAndMortyError on failure
