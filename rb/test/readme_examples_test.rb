...
#      offline in seeded test mode (RickAndMortySDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "RickAndMorty_sdk.rb")
  SDK_CLASS = "RickAndMortySDK"
