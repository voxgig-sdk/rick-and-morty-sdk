# RickAndMorty Ruby SDK



The Ruby SDK for the RickAndMorty API — an entity-oriented client using idiomatic Ruby conventions.
...
- Releases: [https://github.com/voxgig-sdk/rick-and-morty-sdk/releases](https://github.com/voxgig-sdk/rick-and-morty-sdk/releases)
...
```ruby
client = RickAndMortySDK.test(testopts, sdkopts)
```
...
raise a `RickAndMortyError` (a `StandardError` subclass), so wrap
...
| `characters` | `Array` | List of characters who have been seen in this episode |
...
| `residents` | `Array` | List of characters who have been last seen in this location |
...
```
rb/
├── RickAndMorty_sdk.rb       -- Main SDK module
...
The main module (`RickAndMorty_sdk`) exports the SDK class
