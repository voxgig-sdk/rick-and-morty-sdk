...
print_r(array_map(fn($item) => $item->data_get(), $location));
```
...
```
php/
├── rickandmorty_sdk.php          -- Main SDK class
...
The main class (`rickandmorty_sdk.php`) exports the SDK class
