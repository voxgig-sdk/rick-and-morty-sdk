...
// RickAndMorty SDK pipeline test
//
...
{
    private static function utility(): RickAndMortyUtility
    {
        return new RickAndMortyUtility();
    }
    ...
    private static function ctx(array $over = []): RickAndMortyContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new RickAndMortyContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new RickAndMortyOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof RickAndMortyError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new RickAndMortyOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = RickAndMortyMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new RickAndMortyOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = RickAndMortyMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new RickAndMortyOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = RickAndMortyMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RickAndMortySpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = RickAndMortyMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new RickAndMortyResponse([]),
            'result' => new RickAndMortyResult([]),
        ]);
        [, $err] = RickAndMortyMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new RickAndMortySpec([]),
            'response' => null,
            'result' => new RickAndMortyResult([]),
        ]);
        [, $err] = RickAndMortyMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new RickAndMortySpec(['step' => 's']),
            'response' => new RickAndMortyResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new RickAndMortyResult([]),
        ]);
        [, $err] = RickAndMortyMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new RickAndMortySpec(['step' => 's']),
            'response' => new RickAndMortyResponse(self::resp(200, ['v' => 1])),
            'result' => new RickAndMortyResult([]),
        ]);
        [, $err] = RickAndMortyMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new RickAndMortySpec(['step' => 's']),
            'response' => new RickAndMortyResponse(self::resp(200, ['v' => 2])),
            'result' => new RickAndMortyResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        RickAndMortyMakeResponse::call($ctx);
    ...
    {
        $preset = new RickAndMortyResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new RickAndMortySpec([]),
            'response' => new RickAndMortyResponse([]),
            'result' => new RickAndMortyResult([]),
        ...
        [$got, $err] = RickAndMortyMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new RickAndMortyResult([])]);
        [, $err] = RickAndMortyMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new RickAndMortySpec([]), 'result' => null]);
        [, $err] = RickAndMortyMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RickAndMortySpec(['step' => 's']),
            'result' => new RickAndMortyResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new RickAndMortyOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RickAndMortyMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new RickAndMortySpec(['step' => 's']),
            'result' => new RickAndMortyResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new RickAndMortyOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = RickAndMortyMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new RickAndMortyResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new RickAndMortySpec([]),
            'result' => new RickAndMortyResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = RickAndMortyMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RickAndMortyMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new RickAndMortyError('boom', 'boom');
        $utility->fetcher = function (RickAndMortyContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RickAndMortySpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = RickAndMortyMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (RickAndMortyContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = RickAndMortyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(RickAndMortyResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        RickAndMortyMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (RickAndMortyContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new RickAndMortySpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = RickAndMortyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new RickAndMortyResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new RickAndMortySpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = RickAndMortyMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = RickAndMortyMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = RickAndMortyMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new RickAndMortyResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, RickAndMortyDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new RickAndMortyResult(['ok' => false])]);
        $this->expectException(RickAndMortyError::class);
        RickAndMortyDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new RickAndMortyResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', RickAndMortyMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        RickAndMortyMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new RickAndMortyBaseFeature();
        $b = new RickAndMortyBaseFeature();
        RickAndMortyFeatureAdd::call($ctx, $a);
        RickAndMortyFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): RickAndMortyBaseFeature
    {
        $f = new RickAndMortyBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        RickAndMortyFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): RickAndMortyContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new RickAndMortySpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = RickAndMortyPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        RickAndMortyPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new RickAndMortyResponse(['headers' => null]),
            'result' => new RickAndMortyResult([]),
        ]);
        RickAndMortyResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        RickAndMortyResultBody::call($ctx);
