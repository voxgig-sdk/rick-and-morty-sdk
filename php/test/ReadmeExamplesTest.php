...
// RickAndMorty SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RickAndMortySDK::test)
...
{
    private const SDK_CLASS = 'RickAndMortySDK';
    ...
    private const SDK_BASE = 'rickandmorty_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../rickandmorty_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
