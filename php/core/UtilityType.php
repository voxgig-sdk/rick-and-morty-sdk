...
// RickAndMorty SDK utility type

class RickAndMortyUtility
{
    ...
    public static function copy(RickAndMortyUtility $src): RickAndMortyUtility
    {
        $u = new RickAndMortyUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
