...
// RickAndMorty SDK ratelimit feature
...
class RickAndMortyRatelimitFeature extends RickAndMortyBaseFeature
{
    ...
    private function _acquire(RickAndMortyContext $ctx): void
    {
    ...
    private function _track(RickAndMortyContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
