...
// RickAndMorty SDK metrics feature
...
class RickAndMortyMetricsFeature extends RickAndMortyBaseFeature
{
    ...
    private function _record(RickAndMortyContext $ctx, bool $ok): void
    {
