...
// RickAndMorty SDK debug feature
...
class RickAndMortyDebugFeature extends RickAndMortyBaseFeature
{
    ...
    private function _finish(RickAndMortyContext $ctx, bool $ok): void
    {
