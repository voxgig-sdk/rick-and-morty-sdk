...
// RickAndMorty SDK cache feature
...
class RickAndMortyCacheFeature extends RickAndMortyBaseFeature
{
    ...
    private function _through(RickAndMortyContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
