...
class RickAndMortyRbacFeature extends RickAndMortyBaseFeature
{
    ...
    private function _required(RickAndMortyContext $ctx): ?string
    {
    ...
    private function _reject(RickAndMortyContext $ctx, string $required): void
    {
    ...
    private function _track(RickAndMortyContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
