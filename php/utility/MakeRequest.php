...
// RickAndMorty SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RickAndMortyMakeRequest
{
    public static function call(RickAndMortyContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RickAndMortyResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RickAndMortyResponse($fetched);
        } else {
